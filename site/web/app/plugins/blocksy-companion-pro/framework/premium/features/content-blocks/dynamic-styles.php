...
$block_position = blocksy_default_akg( 'content_block_position', $atts, 'default' );

if ($block_position === 'fixed') {
	blocksy_output_responsive([
		'css' => $css,
		'tablet_css' => $tablet_css,
		'mobile_css' => $mobile_css,
		'selector' => blocksy_prefix_selector('', 'block:' . $id),
		'variableName' => 'block-offset',
		'unit' => '',
		'value' => blocksy_default_akg('fixed_offset', $atts, '0px')
	]);
}
