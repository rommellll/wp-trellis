	...
	public function __construct() {
		add_action('admin_enqueue_scripts', function () {
			...
			wp_enqueue_script(
				...
				BLOCKSY_URL . 'framework/premium/extensions/adobe-typekit/static/bundle/dashboard.js',
				['ct-events','ct-options-scripts', 'ct-dashboard-scripts'],
				$data['Version']
			);

			wp_enqueue_style(
				'blocksy-ext-adobe-typekit-admin-dashboard-styles',
				BLOCKSY_URL . 'framework/premium/extensions/adobe-typekit/static/bundle/dashboard.min.css',
				[],
				$data['Version']
			);
		});
