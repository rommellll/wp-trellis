        ...
        <div class="wopb-container-grid">
                ...
                <div class="wopb-card wopb-p25">
                    <iframe
                        ...
                        <div class="wopb-feature-btn">
                            <a class="wopb-btn wopb-btn-primary" target="_blank" href="<?php echo esc_url(wopb_function()->get_premium_link("https://www.wpxpo.com/productx/", 'productx_dashboard_details')); ?>"><?php esc_html_e('Plugin Details', 'product-blocks'); ?></a>
                            <a class="wopb-btn wopb-btn-transparent" href="<?php echo esc_url(wopb_function()->get_premium_link('https://www.wpxpo.com/productx/starter-packs/', 'productx_dashboard_go_library')); ?>"><?php esc_html_e('Go to Templates Library', 'product-blocks'); ?></a>
                        </div>
                </div>
                ...
                <div class="wopb-features">
                    ...
                    <div class="wopb-text-center">
                        <a class="wopb-btn wopb-btn-primary" target="_blank"
                           href="<?php echo esc_url(wopb_function()->get_premium_link("https://www.wpxpo.com/productx/", 'productx_dashboard_explore_features')); ?>"
                        >
           ...
           <div class="wopb-admin-sidebar">
                        <?php if (!wopb_function()->isActive()) { ?>
                            ...
                            <?php $banner->sidebar_additional_feature(); ?>
