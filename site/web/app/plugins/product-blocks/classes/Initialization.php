...
class Initialization{
    ...
    public function __construct(){
        ...
        add_action( 'in_plugin_update_message-'.WOPB_BASE, array( $this, 'in_plugin_settings_update_message' ) ); // Show changelog in Plugin
    ...
    public function register_scripts_back_callback() {
        ...
        if (wopb_function()->is_wc_ready()) {
            ...
            wp_localize_script('wopb-blocks-editor-script', 'wopb_data', array(
                ...
                'settings' => wopb_function()->get_setting(),
                'productTaxonomyList' => wopb_function()->get_product_taxonomies(),
            ));
